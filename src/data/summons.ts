...
import { UNIT_IDS_BY_RARITY } from '../../lib/gameRules';

const SSR_UNITS = [...UNIT_IDS_BY_RARITY.SSR];
const SR_UNITS = [...UNIT_IDS_BY_RARITY.SR];
const R_UNITS = [...UNIT_IDS_BY_RARITY.R];
const N_UNITS = [...UNIT_IDS_BY_RARITY.N];
